...
// Discard allocated graphs before sharing device buffers. Callers must serialize all use of both allocators.
GGML_API bool ggml_gallocr_share_buffers(ggml_gallocr_t dst, ggml_gallocr_t src);
